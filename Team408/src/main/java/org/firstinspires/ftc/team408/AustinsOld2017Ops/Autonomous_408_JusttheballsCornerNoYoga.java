 ...
 */
@Autonomous(name = "BallsCornerNoYoga", group = "LinearOpMode")
@Disabled
public class Autonomous_408_JusttheballsCornerNoYoga extends LinearOpMode {
