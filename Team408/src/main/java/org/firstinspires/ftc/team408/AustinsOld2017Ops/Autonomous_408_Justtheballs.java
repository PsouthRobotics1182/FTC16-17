 ...
 */
@Autonomous(name = "Balls RED", group = "LinearOpMode")
@Disabled
public class Autonomous_408_Justtheballs extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveBackwardsFor(500, 0.5);

        shootBalls();

        rotateLeft(0.97 * Math.PI / 1.7, HALF_POWER);

        driveBackwardsFor(1000, 0.5);
